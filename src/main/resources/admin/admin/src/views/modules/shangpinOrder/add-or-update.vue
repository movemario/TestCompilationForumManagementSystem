        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="跳蚤市场" prop="shangpinId">
                        <el-select v-model="ruleForm.shangpinId" :disabled="ro.shangpinId" filterable placeholder="请选择跳蚤市场" @change="shangpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品名称  Search11 1" prop="shangpinName">
                        <el-input v-model="shangpinForm.shangpinName"
                                  placeholder="商品名称  Search11 1" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品名称  Search11 1" prop="shangpinName">
                            <el-input v-model="ruleForm.shangpinName"
                                      placeholder="商品名称  Search11 1" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='shangpin' ">
